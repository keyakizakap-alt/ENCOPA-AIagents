...
const server=createServer(async(req,res)=>{
 if(req.method==='GET'&&req.url==='/count'){res.writeHead(200,{'Content-Type':'application/json'});res.end(JSON.stringify({count:requestCount}));return}
