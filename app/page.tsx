      ...
      <div className="min-w-0">
        <div className="mb-4 flex items-center justify-between gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            <Button disabled={!chosen} onClick={()=>void sharePlan()} variant="outline" className="hidden h-9 rounded-full border-[#1e2928]/15 bg-white px-4 sm:inline-flex"><Share2 className="mr-2 size-4"/>プラン共有</Button>
        ...
        {(activeView==="home"||activeView==="venues")&&<div className="overflow-hidden rounded-[26px] border border-[#182523]/9 bg-white shadow-[0_14px_40px_rgba(24,37,35,.07)]">
          ...
          <div className="grid items-end gap-3 border-t border-[#182523]/8 bg-white p-4 sm:p-5 [grid-template-columns:repeat(auto-fit,minmax(min(100%,180px),1fr))]">
