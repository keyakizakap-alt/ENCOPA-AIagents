...
import { CoordinationPreview, DesktopNavigation, MobileNavigation, PlanOverview } from "@/components/encopa/planning-shell";
    ...
    <section className="mx-auto grid max-w-[1600px] gap-6 px-4 py-5 sm:px-7 lg:grid-cols-[minmax(0,1fr)_340px] lg:px-10 lg:py-8 2xl:grid-cols-[220px_minmax(0,1fr)_340px]">
      ...
      <div id="home" className="min-w-0 scroll-mt-24">
        ...
        <section id="results" className="scroll-mt-24 pt-8">
          ...
          <section id="participants" aria-label="参加者と連絡" className="scroll-mt-24 pt-5"><CoordinationPreview people={query.people} stage={stage} hasAllergy={hasAllergy}/><CreateGroup title={`${query.purpose}のグループ`} initial={{venueName:chosen.name,address:chosen.address,date:eventDate,time:eventTime,people:query.people,price:chosen.estimatedPrice||query.budget,status:"planning",bookingReference:"",note:"",website:chosen.url}}/></section>
      ...
      <aside id="assistant" className="scroll-mt-24 lg:sticky lg:top-24 lg:self-start">
